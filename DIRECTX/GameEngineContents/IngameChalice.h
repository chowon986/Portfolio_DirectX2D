...
class InGameChalice : public IInGameCharacterBase
{
public:
	...
	// delete Function
	InGameChalice(const InGameChalice& _Other) = delete;
	InGameChalice(InGameChalice&& _Other) noexcept = delete;
	InGameChalice& operator=(const InGameChalice& _Other) = delete;
	InGameChalice& operator=(InGameChalice&& _Other) noexcept = delete;
