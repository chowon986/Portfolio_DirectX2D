...
class MonsterPhysicsComponent : public GameEngineComponent
{
public:
	...
	// delete Function
	MonsterPhysicsComponent(const MonsterPhysicsComponent& _Other) = delete;
	MonsterPhysicsComponent(MonsterPhysicsComponent&& _Other) noexcept = delete;
	MonsterPhysicsComponent& operator=(const MonsterPhysicsComponent& _Other) = delete;
	MonsterPhysicsComponent& operator=(MonsterPhysicsComponent&& _Other) noexcept = delete;
