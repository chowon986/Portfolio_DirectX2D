...
class PawnPhysicsComponent : public GameEngineComponent
{
public:
	...
	// delete Function
	PawnPhysicsComponent(const PawnPhysicsComponent& _Other) = delete;
	PawnPhysicsComponent(PawnPhysicsComponent&& _Other) noexcept = delete;
	PawnPhysicsComponent& operator=(const PawnPhysicsComponent& _Other) = delete;
	PawnPhysicsComponent& operator=(PawnPhysicsComponent&& _Other) noexcept = delete;
